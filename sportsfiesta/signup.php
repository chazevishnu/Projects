...
<html>
	...
	<head>
		<title>INTERNIT SPORTSMEET</title>
		...
		<style type="text/css">
			...
			#container {
    			...
    			margin-top: -330px;
    			margin-left: -170px;
				background: rgba(15,153,153,0.5);
    			border-radius: 10px;
...
<body>
    ...
    <div id="heading">
    	<h2 style="color: #000;"><strong>REGISTER HERE</strong></h2>
    </div>
  <div id="container">       
	<form method="post" action="signup_script.php">
		<label for="first"><strong>FIRST NAME:</strong></label><?php echo $_GET['m1'];?>
		<input type="text" id="first" name="first" placeholder="First Name" required>
		<label for="last"><strong>LAST NAME:</strong></label><?php echo $_GET['m2'];?>
		<input type="text" id="last" name="last" placeholder="Last Name" required>
		<label for="email"><strong>E-MAIL ID:</strong></label><?php echo $_GET['m3'];?>
		<input type="email" id="email" name="email" placeholder="Enter E-Mail Id" required value="">
        
		<label for="roll"><strong>ROLL NO:</strong></label><?php echo $_GET['m4'];?>
		<input type="text" id="roll" name="roll" placeholder="Enter Your Roll no." required>
        <label for="address"><strong>ADDRESS:</strong></label>
		<input type="text" id="address" name="address" placeholder="Enter Your Address" required>
        <label for="npass"><strong>NEW PASSWORD:</strong></label><?php echo $_GET['m5'];?>
		<input type="password" id="npass" name="npass" placeholder="Minimum 6 Characters" required>
        <label for="npass1"><strong>RE-ENTER PASSWORD:</strong></label><?php echo $_GET['m6'];?>
	...
	<div id="alter">
		<form method="post" action="login.php" style"padding-top:2px; padding-left:35px;">
			<label for="back" style="padding-top:2px; padding-left:13px;"> <strong>Go Back for</strong></label>
